...
$commit_migrations = 'create table service_card_device_out_view_mtm and add fk service_card_device_out_view_mtm.card_device_uid -> service_card_device.uid, fk service_card_device_out_view_mtm.out_view_id -> service_out_view.id';
?>